  ...
  return (
    <div className="flex items-center justify-center min-h-[calc(100vh-73px)]">
      <div className="w-full max-w-md p-8 rounded-2xl glass shadow-xl shadow-pastel-blue/20 dark:shadow-emerald-500/5 border border-white dark:border-slate-800 transition-colors duration-300">
        <h2 className="text-3xl font-bold text-center mb-6 text-gray-800 dark:text-slate-100 transition-colors">Log In</h2>
        ...
        <div className="mt-6 text-center text-gray-600 dark:text-slate-400 text-sm transition-colors">
          Need an account? <Link to="/signup" className="text-[#84a9f8] dark:text-emerald-400 hover:text-[#6a95ef] dark:hover:text-emerald-300 font-medium hover:underline transition-colors">Sign Up</Link>
        </div>
      </div>
    </div>
  );
